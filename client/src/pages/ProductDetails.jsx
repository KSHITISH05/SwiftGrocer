...
const ProductDetails = () => {
    ...
    const {products, navigate, currency, addToCart} = useAppContext()//we are using useAppContext to get the products, navigate function, currency and addToCart function
    const {id} = useParams()
    ...
    // If product is not found, return null or handle it as needed
            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {/* why thse lines are doing understand this */}
